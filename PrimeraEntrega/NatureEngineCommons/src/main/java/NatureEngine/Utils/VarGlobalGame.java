...
public class VarGlobalGame {
	...
	public final static float UMBRAL_HAMBRE = (float) 1.0;
	public final static float UMBRAL_CARNIVORO = (float) 0.25;
	public final static float UMBRAL_HERVIBORO = (float) 0.75;
}